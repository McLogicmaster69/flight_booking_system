...
data class StaffSessionData(
    ...
    fun toTokenSession(): StaffSessionToken = StaffSessionToken(sessionToken)
    ...
    companion object {
        ...
        fun delete(id: Int): Int = StaffSessionData(id = id).delete()

        fun createSession(staffId: Int): StaffSessionData {
        ...
        fun queryDatabase(token: String): List<QueryResult<StaffSessionData>> {
