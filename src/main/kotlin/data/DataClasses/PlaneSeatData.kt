...
object PlaneSeatColumns {
    ...
    val PLANE_MODEL_ID =
        Column<Int>("plane_model_id", "INTEGER NOT NULL REFERENCES ${PlaneModelData.EMPTY.tableName}(id)")
...
data class PlaneSeatData(
    ...
    override val tableAdditionalSQL = """
        UNIQUE (
            ${PlaneSeatColumns.PLANE_MODEL_ID.name},
            ${PlaneSeatColumns.CLASS_ID.name}
        )"""
    ...
    companion object {
        ...
        fun delete(id: Int): Int = PlaneSeatData(id = id).delete()
    }
}
