...
data class SessionData(
    ...
    fun toTokenSession(): SessionToken = SessionToken(sessionToken)
    ...
    companion object {
        ...
        fun delete(id: Int): Int = SessionData(id = id).delete()

        fun createSession(userId: Int): SessionData {
        ...
        fun queryDatabase(token: String): List<QueryResult<SessionData>> {
